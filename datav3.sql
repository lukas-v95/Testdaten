...
INSERT INTO Address (addressId, country, province, zipCode, city, street, streetNumber, apartment) VALUES
	...
	(default, 'China', 'Sishilichengzi', null, 'Salto', 'Fairfield', '463', '9'),
	(default, 'Indonesia', 'Cilangkap', null, 'Jacura', 'Basil', '412', '8'),
	...
	(default, 'France', 'Nice', '06293 CEDEX 3', 'Boden', 'Warrior', '270', '39'),
	(default, 'Poland', 'BSczana Dolna', '34-730', 'Licupis', 'Oakridge', '2', '65'),
	(default, 'Brazil', 'Santaluz', '48880-000', 'Głuchów', 'Twin Pines', '4', '6'),
	(default, 'Thailand', 'Sena', '13110', 'Bent Jbaïl', 'Steensland', '00', '41402'),
	(default, 'Sweden', 'Smedjebacken', '777 82', 'La Punta', 'Evergreen', '78', '58995'),
	...
	(default, 'Peru', 'Sangallaya', null, 'Xêgar', 'Helena', '832', '77253'),
	(default, 'France', 'Paris 19', '75166 CEDEX 19', 'Chicago', 'Esch', '95244', '73841'),
	...
	(default, 'Argentina', 'Río Colorado', '8138', 'Ban Houayxay', 'Hansons', '80161', '14'),
	(default, 'Brazil', 'Botucatu', '18600-000', 'Hongshunli', 'Grasskamp', '501', '09'),
	(default, 'Philippines', 'Barong', '2913', 'Strellc i Ulët', 'Stephen', '75916', '572'),
	(default, 'Norway', 'Bodø', '8038', 'Campo Largo', 'Grim', '310', '0'),
	(default, 'United States', 'Houston', '77090', 'Linshi', 'New Castle', '1', '11'),
	(default, 'Argentina', 'Caleufú', '6387', 'Spånga', 'Longview', '4', '12'),
	...
	(default, 'Portugal', 'Padre Nabeto', '2950-107', 'Antas', 'Old Gate', '77', '407'),
	...
	(default, 'Brazil', 'Cruz Alta', '98000-000', 'Nenotes', 'Ilene', '42', '6'),
...
INSERT INTO Contact (contactId, phone, email, fax, creditCardNumber, addressId) VALUES
	...
	(default, '+438188619906', 'hmaggillandreis5@arizona.edu', null, '374283438873838', 6),
	(default, '+432202946612', 'akupke6@coBScenz.com', null, '3585921431915754', 7),
	(default, '+439186045300', 'rvedyashkin7@china.com.cn', null, '3574724075769963', 8),
	(default, '+437432528645', 'dlavery8@exblog.jp', null, '4175002900857514', 9),
	(default, '+438145299847', 'cladel9@list-manage.com', null, '3541881864429439', 10),
	(default, '+432389263219', 'pbeningfielda@dyndns.org', null, '561077858273247767', 11),
	(default, '+435512680556', 'hgynneb@webs.com', null, '3546429475456295', 12),
	(default, '+436422136103', 'lvasyuchovc@huffingtonpost.com', null, '6771720924672717956', 13),
	(default, '+439994603225', 'BScaintpierred@google.de', null, '30071414648803', 14),
	(default, '+437531911265', 'sleglisee@barnesandnoble.com', null, '337941434140280', 15),
	(default, '+435818572899', 'sgeroldif@sciencedirect.com', null, '3586256825109360', 16),
	(default, '+433367442017', 'bbettlesg@eventbrite.com', null, '30015419848645', 17),
	(default, '+437263975129', 'jdearlh@merriam-webster.com', null, '3581035382276589', 18),
	(default, '+432361259615', 'rpitsoni@nymag.com', null, '5602233614089959', 19),
...
<<<<<<< HEAD
	(6, null, 'Heather', 'Maggill''Andreis', '1983-06-18', 'F', false, false),
	(7, null, 'Anderson', 'Kupke', '1980-12-27', 'M', false, true),
	(8, null, 'Rodolfo', 'Vedyashkin', '1978-10-11', 'M', false, false),
	(9, null, 'David', 'Lavery', '1979-09-09', 'M', false, true),
	(10, 'Dr', 'Chancey', 'Ladel', '1990-11-11', 'M', false, false),
	(11, null, 'Pip', 'Beningfield', '1946-11-16', 'M', false, true),
	(12, 'Dipl-Ing.', 'Hank', 'Gynne', '1945-02-05', 'M', false, true),
	(13, 'Dipl-Ing.', 'Lelah', 'Vasyuchov', '1968-01-21', 'F', false, false),
	(14, 'Dr', 'Malvina', 'Saintpierre', '1960-04-20', 'F', false, true),
	(15, null, 'Sigrid', 'Leglise', '1952-12-15', 'F', false, true),
	(16, 'BSc', 'Skylar', 'Geroldi', '1991-10-01', 'M', false, true),
	(17, null, 'Barbi', 'Bettles', '1978-07-25', 'F', false, false),
	(18, null, 'Janeta', 'Dearl', '1983-07-22', 'F', false, false),
	(19, null, 'Ruby', 'Pitson', '1984-09-22', 'F', false, true),
...
=======
	...
	(19, 'Dipl-Ing.', 'Sada', 'Cullnean', '1999-08-16', 'F', 'false', true),
	...
	(35, null, 'Krysta', 'Schenkel', '1999-08-21', 'F', 'false', true),
	...
	(48, null, 'Frans', 'Deverill', '1999-06-21', 'M', 'false', true),
	(49, null, 'Cyrus', 'Dibley', '1944-02-09', 'M', 'false', true),
	(50, 'Dipl-Ing.', 'Kyle', 'Rich', '1974-08-07', 'M', 'false', true),
	(51, null, 'Trevor', 'Kernes', '1999-11-13', 'M', 'false', false),
